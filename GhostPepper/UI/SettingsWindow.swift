                ...
                if appState.preferredLanguage != "auto" && appState.preferredLanguage != "en" && appState.speechModel.hasSuffix(".en") {
                    HStack(spacing: 6) {
                        Image(systemName: "exclamationmark.triangle.fill")
                            ...
                            .font(.caption)
                        Text("You've selected a non-English language but are using an English-only model. Switch to **Multilingual**, **Whisper large v3 turbo (full, multilingual)**, **Whisper large v3 turbo (q5_0, multilingual)**, or **Parakeet v3** above for best results.")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
                }
